...
cd "/camp/lab/znamenskiyp/home/users/hey2/codes/cottage_analysis/cottage_analysis/depth_analysis/analysis/"
python fit_gaussian_blob.py ${PROJECT} ${MOUSE} ${SESSION}